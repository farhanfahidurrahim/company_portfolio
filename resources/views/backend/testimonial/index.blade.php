        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <h6><a href="" class="btn btn-xs btn-link btn-toggle-fullwidth"></a>
                            	Total Testimonial : {{App\Models\Testimonial::count()}}
                            </h6>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                            <ul class="breadcrumb">
                            	<a href="{{ route('testimonial.create') }}" class="btn btn-info"><i class="icon-plus"></i> Create New Testimonial</a>
                        	</ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>All Testimonial</strong> List</h2>
                        </div>
                        <div class="body">
