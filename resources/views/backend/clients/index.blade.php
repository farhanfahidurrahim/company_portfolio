        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                            <ul class="breadcrumb">
                            	<a href="{{ route('client.create') }}" class="btn btn-info"><i class="icon-plus"></i> Create New Client</a>
                        	</ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>All Clients</strong> List</h2>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->name }}</td>
                                            <td><img src="{{ $row->logo }}" style="max-height: 50px; max-width: 75px;" alt="news img"></td>
                                            <td>
                                            ...
                                            <td class="">
                                            	<a href="{{ route('client.edit',$row->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-sm btn-outline-warning"><i class="fas fa-edit"></i></a>

                                            	<form class="px-3" onclick="return confirm('Are you sure you want to delete?')" method="POST"
                                                action="{{ route('client.destroy', $row->id) }}">
                                                    @csrf
                                                    @method('DELETE')
